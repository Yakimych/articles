...
For node.js APIs written in TypeScript it is even possible to generate both the swagger spec and code for runtime validation via [tsoa](https://github.com/lukeautry/tsoa) (see [this comment](https://dev.to/cubiclebuddha/comment/dke7) for more details).
